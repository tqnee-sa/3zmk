    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <!--            <a href="{{route('country_restaurants' , $country->id)}}">-->
                <!--                @lang('messages.restaurants')-->
                <!--            </a>-->
                <!--        </li>-->
                <!--    </ol>-->
                                                ...
                                                @else
                                                    <li class="login_res">
                                                        <a class="btn btn-secondary"
                                                           href="{{route('ArchiveRestaurant' , [$restaurant->id , 'true'])}}">
                                             <i class="fa fa-file"></i>
                                                             </a>
                                                           <span class="show_text">                 @lang('messages.archive')
                                                ...
                                                <li class="login_res" >
                                                    ...
                                                    <span class="show_text">           @lang('messages.histories')</span>
                                                </li>
                                                <li class="login_res">

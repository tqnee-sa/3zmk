...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.add') @lang('messages.countries') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.add') @lang('messages.countries') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('countries.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="currency_ar" type="text" class="form-control" value="{{old('currency_ar')}}" placeholder="@lang('messages.currency_ar')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="currency_en" type="text" class="form-control" value="{{old('currency_en')}}" placeholder="@lang('messages.currency_en')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="code" type="text" class="form-control" value="{{old('code')}}" placeholder="@lang('messages.country_code')">
                                    @if ($errors->has('code'))
                                        <span class="help-block">

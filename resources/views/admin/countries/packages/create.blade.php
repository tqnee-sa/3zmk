...
@section('title')
    @lang('messages.add') @lang('messages.country_packages')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.add') @lang('messages.country_packages') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.add') @lang('messages.country_packages') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('country_packages.store' , $country->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="branch_price" type="number" class="form-control" value="{{old('branch_price')}}" placeholder="@lang('messages.branch_price')">

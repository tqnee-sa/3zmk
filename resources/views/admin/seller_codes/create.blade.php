            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                    <!-- form start -->
                        <form role="form" action="{{route('seller_codes.store')}}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="seller_name" type="text" class="form-control"
                                           value="{{old('seller_name')}}" placeholder="@lang('messages.seller_name')">
...
{{--                                           value="{{old('percentage')}}" placeholder="@lang('messages.percentage')">--}}
...
{{--                                </div>--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="start_at" type="date" class="form-control" value="{{old('start_at')}}"

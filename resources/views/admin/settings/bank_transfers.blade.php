...
@section('title')
    @lang('messages.az_bank_transfers')
@endsection
                        ...
                        <table id="example1" class="table table-striped">
                            ...
                            @foreach($transfers as $transfer)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        {{number_format((float)$transfer->price, 2, '.', '')}}
                                    </td>
                                    <td>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-info">
                                                    ...
                                                    <div class="modal-body">
                                                        <img
                                                            src="{{asset('/uploads/az_transfers/' . $transfer->transfer_photo)}}"
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info"
                                           href="{{route('subscription.confirm_status' ,[$transfer->id,'confirm'] )}}">
                                            <i class="fa fa-calculator"></i> @lang('messages.confirm')
                                        </a>
                                        <a class="btn btn-danger"
                                           href="{{route('subscription.confirm_status' , [$transfer->id,'cancel'])}}">

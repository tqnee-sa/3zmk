            ...
            <div class="col-lg-6 col-6">
                ...
                <div class="small-box bg-silver">
                    <div class="inner">
                        ...
                        <p>{{app()->getLocale() == 'ar' ? 'أجمالي الشهر شامل الضريبة' : 'Month Total Amount Including Tax'}}</p>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-5">
                ...
                <div class="small-box bg-silver">
                    <div class="inner">
                        <h5>
                            {{number_format((float)($month_total_amount - $tax_values), 0, '.', '')}}
                        </h5>

                        <p>{{app()->getLocale() == 'ar' ? 'أجمالي الشهر بدون ضريبة' : 'Month Total Amount Without Tax'}}</p>
                    </div>
                    <div class="icon" style="color: black">
                        <i class="fa fa-calculator"></i>
                    </div>
            ...
            <div class="col-lg-5 col-5">
                ...
                <div class="small-box bg-silver">
                    <div class="inner">
                        <h5>
                            {{number_format((float)$tax_values, 0, '.', '')}}
                        </h5>

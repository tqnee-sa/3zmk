            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('copyMenuCategoryPost') }}" method="post"
                                ...
                                @if (Auth::guard('restaurant')->user()->ar == 'true')
                                    <div class="form-group">
                                        ...
                                        <input name="name_ar" type="text" class="form-control"
                                            value="{{ $category->name_ar }}" placeholder="@lang('messages.name_ar')">
                                ...
                                @if (Auth::guard('restaurant')->user()->en == 'true')
                                    <div class="form-group">
                                        ...
                                        <input name="name_en" type="text" class="form-control"
                                            value="{{ $category->name_en }}" placeholder="@lang('messages.name_en')">
                                ...
                                <div class="image-editor-preview ">
                                    <div class="col-md-12">
                                        ...
                                        <div dir=rtl class="file-loading">
                                            <input type="file" name="image" id="normal-image2"

...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>  @lang('messages.bank_transfer') </h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                ...
                <div class="col-md-9">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"> @lang('messages.bank_transfer') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('AzmakBankTransfer' , $restaurant->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                @php
                                    $currency = app()->getLocale() == 'ar' ? $restaurant->country->currency_ar : $restaurant->country->currency_en;
                                @endphp

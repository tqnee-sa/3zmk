...
@section('title')
    @lang('messages.edit') @lang('messages.sensitivities')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.edit') @lang('messages.sensitivities') </h1>
                </div>
                <!--<div class="col-sm-6">-->
                ...
                <!-- general form elements -->
                    <div class="card ">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.edit') @lang('messages.sensitivities') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('sensitivities.update' , $sensitivity->id)}}" method="post"
                                ...
                                @if(Auth::guard('restaurant')->user()->ar == 'true')
                                    <div class="form-group">
                                        ...
                                        <input name="name_ar" type="text" class="form-control"
                                               value="{{$sensitivity->name_ar}}" placeholder="@lang('messages.name_ar')">
                                ...
                                @if(Auth::guard('restaurant')->user()->en == 'true')
                                    <div class="form-group">
                                        ...
                                        <input name="name_en" type="text" class="form-control"
                                               value="{{$sensitivity->name_en}}" placeholder="@lang('messages.name_en')">
                                ...
                                @if(Auth::guard('restaurant')->user()->ar == 'true')
                                    <div class="form-group">
                                        ...
                                        <textarea class="textarea" name="details_ar"
                                                  ...
                                                  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; pediting: 10px;">{{$sensitivity->details_ar}}</textarea>
                                ...
                                @if(Auth::guard('restaurant')->user()->en == 'true')
                                    <div class="form-group">
                                        ...
                                        <textarea class="textarea" name="details_en"
                                                  ...
                                                  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; pediting: 10px;">{{$sensitivity->details_en}}</textarea>

...
@section('title')
    @lang('messages.add') @lang('messages.rate_us')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.add') @lang('messages.rate_us') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.add') @lang('messages.rate_us') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('restaurant_rate_us.store')}}" method="post" enctype="multipart/form-data">
                            <input type = 'hidden' name = '_token' value = '{{Session::token()}}'>

                            <div class="card-body">
                                <div class="form-group">
                                    <label class="control-label"> @lang('messages.question_ar') </label>
                                    <input name="question_ar" type="text" class="form-control" value="{{old('question_ar')}}" placeholder="@lang('messages.question_ar')">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input name="more_option" type="radio" value="five_rate"> {{app()->getLocale() == 'ar' ? 'التقييم من 1 الي 5' : 'rate from 1 to 5'}}
                                    <input name="more_option" type="radio" value="ten_rate"> {{app()->getLocale() == 'ar' ? 'التقييم  من 1 الي 10' : 'rate from 1 to 10'}}

                        ...
                        <table id="example1" class="table  table-striped">
                            ...
                            @foreach($posters as $poster)
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo ++$i ?></td>
                                    <td>
                                        {{app()->getLocale() == 'ar' ? ($poster->name_ar == null ? $poster->name_en : $poster->name_ar) : ($poster->name_en == null ? $poster->name_ar : $poster->name_en)}}
                                    </td>

                                    <td>
                                        <button type="button" class="btn btn-info" data-toggle="modal"
                                                data-target="#modal-info-{{$poster->id}}">
                                            <i class="fa fa-eye"></i>
                                            <img src="{{asset('/uploads/posters/' . $poster->poster)}}" width="70"
                                                 height="70">
                                        </button>
                                        <div class="modal fade" id="modal-info-{{$poster->id}}">
        ...
        $(document).ready(function () {
            $('body').on('click', '.delete_data', function () {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/restaurant/posters/delete/" + id;

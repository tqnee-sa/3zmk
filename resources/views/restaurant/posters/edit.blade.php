...
@section('title')
    @lang('messages.edit') @lang('messages.posters')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.edit') @lang('messages.posters') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.edit') @lang('messages.posters') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('posters.update' , $poster->id)}}" method="post"
                            ...
                            <div class="card-body">
                                @if(Auth::guard('restaurant')->user()->ar == 'true')
                                    <div class="form-group">
                                        ...
                                        <input name="name_ar" type="text" class="form-control"
                                               value="{{$poster->name_ar}}" placeholder="@lang('messages.name_ar')">
                                ...
                                @if(Auth::guard('restaurant')->user()->en == 'true')
                                    <div class="form-group">
                                        ...
                                        <input name="name_en" type="text" class="form-control"
                                               value="{{$poster->name_en}}" placeholder="@lang('messages.name_en')">
                                ...
                                <div class="form-group ">
                                    <label class="control-label col-md-3"> @lang('messages.poster') </label>
                                    <div class="col-md-9">

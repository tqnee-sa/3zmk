...
@section('title')
    @lang('messages.add') @lang('messages.branch_periods')
@endsection
@section('style')
@endsection
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.add') @lang('messages.branch_periods') </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{route('BranchPeriod' , $branch->id)}}">
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.add') @lang('messages.branch_periods') </h3>
                        </div>
                        <!-- form start -->
                        <form role="form" action="{{route('storeBranchPeriod' , $branch->id)}}" method="post"

...
@section('title')
    @lang('messages.add') @lang('dashboard.header_footer')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.add') @lang('dashboard.header_footer') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.add') @lang('dashboard.header_footer') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('restaurant.related_code.store')}}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name" type="text" class="form-control" rows="6"
                                            placeholder="@lang('dashboard.entry.name') ..." value="{{old('name')}}">
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="header" type="text" class="form-control" rows="6"
                                            placeholder="@lang('dashboard.header') ...">{!! old('header') !!}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="footer" type="text" class="form-control" rows="6"
                                            placeholder="@lang('dashboard.footer') ...">{!! old('footer') !!}</textarea>

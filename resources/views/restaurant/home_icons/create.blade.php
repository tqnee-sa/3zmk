...
@section('title')
    @lang('messages.add') @lang('dashboard.home_icons')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.add') @lang('dashboard.home_icons') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.add') @lang('dashboard.home_icons') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('restaurant.home_icons.store')}}" method="post"
                            ...
                            <div class="card-body">
                                @if(Auth::guard('restaurant')->user()->ar == 'true')
                                    <div class="form-group">
                                        ...
                                        <input name="title_ar" type="text" class="form-control"
                                               value="{{old('title_ar')}}" placeholder="@lang('dashboard.entry.title_ar')">
                                ...
                                @if(Auth::guard('restaurant')->user()->en == 'true')
                                    <div class="form-group">
                                        ...
                                        <input name="title_en" type="text" class="form-control"
                                               value="{{old('title_en')}}" placeholder="@lang('dashboard.entry.title_en')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="link" type="text" class="form-control"
                                           value="{{old('link')}}" placeholder="@lang('dashboard.entry.link')">
                                    @if ($errors->has('link'))
                                        <span class="help-block">
                                ...
                                <div class="form-group ">
                                    <label class="control-label col-md-3"> @lang('dashboard.entry.icon') </label>
                                    <div class="col-md-9">

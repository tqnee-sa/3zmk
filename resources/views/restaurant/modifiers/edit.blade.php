                        ...
                        <form role="form" action="{{ route('modifiers.update', $modifier->id) }}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="is_ready" type="radio" value="true"
                                        {{ $modifier->is_ready == 'true' ? 'checked' : '' }}> @lang('messages.yes')
                                    <input name="is_ready" type="radio" value="false"
                                        {{ $modifier->is_ready == 'false' ? 'checked' : '' }}> @lang('messages.no')
                                ...
                                <div class="form-group">
                                    <label class="control-label">
                                        {{ app()->getLocale() == 'ar' ? 'الاختيار  من الإضافة' : 'Choose' }} </label>
                                    <input name="choose" type="radio" {{ $modifier->choose == 'one' ? 'checked' : '' }}
                                        value="one"> {{ app()->getLocale() == 'ar' ? 'واحد' : 'one' }}
                                    <input name="choose" type="radio"
                                        {{ $modifier->choose == 'multiple' ? 'checked' : '' }} value="multiple">
                                    {{ app()->getLocale() == 'ar' ? 'متعدد' : 'Multiple' }}
                                    <input name="choose" type="radio" value="custom"
                                        {{ $modifier->choose == 'custom' ? 'checked' : '' }}>

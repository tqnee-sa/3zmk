...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('dashboard.urgent_barcode')</h1>
                </div>
                <!--<div class="col-sm-6">-->
                <!--    <ol class="breadcrumb float-sm-right">-->
                <!--        <li class="breadcrumb-item"><a href="{{url('/restaurant/home')}}">@lang('messages.control_panel')</a></li>-->
                <!--        <li class="breadcrumb-item active"> @lang('dashboard.urgent_barcode') </li>-->
                <!--    </ol>-->
                <!--</div>-->
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-body">
                            ...
                            $url = 'https://easymenu-qr.com/restaurants/' . $name;
                            ...
                            <div class="form-group">
                                <h3 class="text-center">
                                    ...
                                    {{--                            <a class="btn " href="{{ URL::to('/hotel/create_pdf') }}"> @lang('messages.saveAsPdf')</a>--}}
                                </h3>
                                <div class="card">

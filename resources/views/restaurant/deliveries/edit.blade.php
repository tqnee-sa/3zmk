...
@section('title')
    @lang('messages.edit') @lang('messages.deliveries')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.edit') @lang('messages.deliveries') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.edit') @lang('messages.deliveries') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('deliveries.update' , $delivery->id)}}" method="post"
                            ...
                            <div class="card-body">
                                @if(Auth::guard('restaurant')->user()->ar == 'true')
                                    <div class="form-group">
                                        ...
                                        <input name="name_ar" type="text" class="form-control"
                                               value="{{$delivery->name_ar}}" placeholder="@lang('messages.name_ar')">
                                ...
                                @if(Auth::guard('restaurant')->user()->en == 'true')
                                    <div class="form-group">
                                        ...
                                        <input name="name_en" type="text" class="form-control"
                                               value="{{$delivery->name_en}}" placeholder="@lang('messages.name_en')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="link" type="url" class="form-control" value="{{$delivery->link}}"
                                           placeholder="@lang('messages.link')">
                                    @if ($errors->has('link'))
                                        <span class="help-block">
                                ...
                                <div class="form-group ">
                                    <label class="control-label col-md-3"> @lang('messages.icon') </label>
                                    <div class="col-md-9">

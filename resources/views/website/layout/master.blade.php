...
{{--            </span>--}}
        ...
        @endif
        <div class="row">
            <div class="col-sm-3 btn text-center" style="background-color: {{$restaurant->az_color ? $restaurant->az_color->icons : '#dbd6db'}} !important; margin: 10px;">
            ...
            <div class="col-sm-3 btn" style="background-color: {{$restaurant->az_color ? $restaurant->az_color->icons : '#dbd6db'}} !important; margin: 10px;">
                <a style="color: {{$restaurant->az_color?->options_description}} !important; font-size: 13px"

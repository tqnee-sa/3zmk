<div class=" p-3"
    ...
    @if ($products->count() > 0)
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade {{ $restaurant->az_info->menu_show_type == 'style3' ? 'show active' : '' }}"
            ...
            <!-- end home-tab -->
            <div class="tab-pane fade {{ $restaurant->az_info->menu_show_type == 'style2' ? 'show active' : '' }}"
            ...
            <!-- profile-tab -->
            <div class="tab-pane fade {{ $restaurant->az_info->menu_show_type == 'style1' ? 'show active' : '' }}"

...
<head>
    ...
    <title>@lang('messages.join_us')</title>
    <!-- //font -->
...
<div class="mycontainer">
    ...
    <main>
        ...
        >
            ...
            <br><br><br>
            <p class="px-3">
                إنضم إلى قائمة عملائنا المميزين، يرجى تعبئة الحقول وسيتواصل معك
                فريقنا في أقرب وقت
            </p>
            <form method="post" action="{{route('AZUserRegisterSubmit' , [$restaurant->name_barcode , $branch->name_en])}}">
                @csrf
                <div class="m-2 px-1 container_form">
                    <div class="name">
                        ...
                        <div class="container_input">
                            ...
                            <input type="text" id="name" name="name" value="{{old('name')}}" placeholder="@lang('messages.name')" />
                        </div>
                        @if ($errors->has('name'))
                ...
                <input type="submit" value="@lang('messages.send')" class="my-5" />
            </form>
        </div>
    </main>
